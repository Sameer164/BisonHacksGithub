...
setup_page("🧪 Quizzes", sidebar_state="collapsed")

st.title("🧪 Quizzes")
st.markdown("---")

# Add your quiz page content here
st.write("Test your knowledge with our interactive quizzes!")

if "ask_results" not in st.session_state:
    st.session_state["ask_results"] = {}

Create_Quiz = st.container()
